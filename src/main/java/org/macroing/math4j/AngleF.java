...
public final class AngleF {
	...
	public String toString() {
		return String.format("AngleF.degrees(%s, %s, %s)", Float.toString(this.degrees), Float.toString(this.degreesMinimum), Float.toString(this.degreesMaximum));
	}
	...
	public boolean equals(final Object object) {
		if(object == this) {
			...
			return false;
		} else if(!MathF.equals(this.degrees, AngleF.class.cast(object).degrees)) {
			return false;
		} else if(!MathF.equals(this.degreesMaximum, AngleF.class.cast(object).degreesMaximum)) {
			return false;
		} else if(!MathF.equals(this.degreesMinimum, AngleF.class.cast(object).degreesMinimum)) {
			return false;
		} else if(!MathF.equals(this.radians, AngleF.class.cast(object).radians)) {
			return false;
		} else if(!MathF.equals(this.radiansMaximum, AngleF.class.cast(object).radiansMaximum)) {
			return false;
		} else if(!MathF.equals(this.radiansMinimum, AngleF.class.cast(object).radiansMinimum)) {
			return false;
		} else {
			return true;
		}
