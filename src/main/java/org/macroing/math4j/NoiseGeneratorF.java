...
/**
 * A {@code NoiseGeneratorF} is able to generate noise using various algorithms and with a data type of {@code float}.
 * <p>
 ...
 */
public final class NoiseGeneratorF {
	...
	/**
	 * Constructs a new {@code NoiseGeneratorF} instance.
	 * <p>
	 * Calling this constructor is equivalent to the following:
	 * <pre>
	 * {@code
	 * new NoiseGeneratorF(0.5F, 0.2F, 1.0F / 2.0F, 2.0F, 2);
	 * }
	 * </pre>
	 */
	public NoiseGeneratorF() {
		this(0.5F, 0.2F, 1.0F / 2.0F, 2.0F, 2);
	}
	 ...
	 */
	public NoiseGeneratorF(final float amplitude, final float frequency, final float gain, final float lacunarity, final int octaves) {
	 ...
	 */
	public float perlinFractal(final float x, final float y, final float z) {
	 ...
	 */
	public float perlinTurbulence(final float x, final float y, final float z) {
	 ...
	 */
	public float simplexFractal(final float x) {
	 ...
	 */
	public float simplexFractal(final float x, final float y) {
	 ...
	 */
	public float simplexFractal(final float x, final float y, final float z) {
	 ...
	 */
	public float simplexFractal(final float x, final float y, final float z, final float w) {
	 ...
	 */
	public float simplexTurbulence(final float x) {
	 ...
	 */
	public float simplexTurbulence(final float x, final float y) {
	 ...
	 */
	public float simplexTurbulence(final float x, final float y, final float z) {
	 ...
	 */
	public float simplexTurbulence(final float x, final float y, final float z, final float w) {
	 ...
	 * @return a {@code float} with noise computed by a Perlin-based fractal algorithm using the coordinates X, Y and Z
	 */
	public static float perlinFractal(final float x, final float y, final float z, final float amplitude, final float frequency, final float gain, final float lacunarity, final int octaves) {
		float result = 0.0F;
	 ...
	 */
	public static float perlinFractionalBrownianMotion(final float x, final float y, final float z, final float frequency, final float gain, final float minimum, final float maximum, final int octaves) {
	 ...
	 */
	public static float perlinNoise(final float x, final float y, final float z) {
	 ...
	 * @return a {@code float} with noise computed by a Perlin-based turbulence algorithm using the coordinates X, Y and Z
	 */
	public static float perlinTurbulence(final float x, final float y, final float z, final float amplitude, final float frequency, final float gain, final float lacunarity, final int octaves) {
		float currentAmplitude = amplitude;
		float currentFrequency = frequency;
	 ...
	 * @return a {@code float} with noise computed by a Simplex-based fractal algorithm using the coordinate X
	 */
	public static float simplexFractal(final float x, final float amplitude, final float frequency, final float gain, final float lacunarity, final int octaves) {
		float result = 0.0F;
	 ...
	 * @return a {@code float} with noise computed by a Simplex-based fractal algorithm using the coordinates X and Y
	 */
	public static float simplexFractal(final float x, final float y, final float amplitude, final float frequency, final float gain, final float lacunarity, final int octaves) {
		float result = 0.0F;
	 ...
	 * @return a {@code float} with noise computed by a Simplex-based fractal algorithm using the coordinates X, Y and Z
	 */
	public static float simplexFractal(final float x, final float y, final float z, final float amplitude, final float frequency, final float gain, final float lacunarity, final int octaves) {
		float result = 0.0F;
	 ...
	 * @return a {@code float} with noise computed by a Simplex-based fractal algorithm using the coordinates X, Y, Z and W
	 */
	public static float simplexFractal(final float x, final float y, final float z, final float w, final float amplitude, final float frequency, final float gain, final float lacunarity, final int octaves) {
		float result = 0.0F;
	 ...
	 */
	public static float simplexFractionalBrownianMotion(final float x, final float frequency, final float gain, final float minimum, final float maximum, final int octaves) {
		float currentAmplitude = 1.0F;
		float maximumAmplitude = 0.0F;
	 ...
	 */
	public static float simplexFractionalBrownianMotion(final float x, final float y, final float frequency, final float gain, final float minimum, final float maximum, final int octaves) {
		float currentAmplitude = 1.0F;
		float maximumAmplitude = 0.0F;
	 ...
	 */
	public static float simplexFractionalBrownianMotion(final float x, final float y, final float z, final float frequency, final float gain, final float minimum, final float maximum, final int octaves) {
		float currentAmplitude = 1.0F;
		float maximumAmplitude = 0.0F;
	 ...
	 */
	public static float simplexFractionalBrownianMotion(final float x, final float y, final float z, final float w, final float frequency, final float gain, final float minimum, final float maximum, final int octaves) {
		float currentAmplitude = 1.0F;
		float maximumAmplitude = 0.0F;
	 ...
	 */
	public static float simplexNoise(final float x) {
	 ...
	 */
	public static float simplexNoise(final float x, final float y) {
		...
		final float n0 = t0 < 0.0F ? 0.0F : (t0 * t0) * (t0 * t0) * doDotXY(SIMPLEX_GRADIENT_3[gi0 * 3 + 0], SIMPLEX_GRADIENT_3[gi0 * 3 + 1], x0, y0);
		
		final float t1 = 0.5F - x1 * x1 - y1 * y1;
		final float n1 = t1 < 0.0F ? 0.0F : (t1 * t1) * (t1 * t1) * doDotXY(SIMPLEX_GRADIENT_3[gi1 * 3 + 0], SIMPLEX_GRADIENT_3[gi1 * 3 + 1], x1, y1);
		
		final float t2 = 0.5F - x2 * x2 - y2 * y2;
		final float n2 = t2 < 0.0F ? 0.0F : (t2 * t2) * (t2 * t2) * doDotXY(SIMPLEX_GRADIENT_3[gi2 * 3 + 0], SIMPLEX_GRADIENT_3[gi2 * 3 + 1], x2, y2);
	 ...
	 */
	public static float simplexNoise(final float x, final float y, final float z) {
		...
		final float n0 = t0 < 0.0F ? 0.0F : (t0 * t0) * (t0 * t0) * doDotXYZ(SIMPLEX_GRADIENT_3[gi0 * 3 + 0], SIMPLEX_GRADIENT_3[gi0 * 3 + 1], SIMPLEX_GRADIENT_3[gi0 * 3 + 2], x0, y0, z0);
		
		final float t1 = 0.6F - x1 * x1 - y1 * y1 - z1 * z1;
		final float n1 = t1 < 0.0F ? 0.0F : (t1 * t1) * (t1 * t1) * doDotXYZ(SIMPLEX_GRADIENT_3[gi1 * 3 + 0], SIMPLEX_GRADIENT_3[gi1 * 3 + 1], SIMPLEX_GRADIENT_3[gi1 * 3 + 2], x1, y1, z1);
		
		final float t2 = 0.6F - x2 * x2 - y2 * y2 - z2 * z2;
		final float n2 = t2 < 0.0F ? 0.0F : (t2 * t2) * (t2 * t2) * doDotXYZ(SIMPLEX_GRADIENT_3[gi2 * 3 + 0], SIMPLEX_GRADIENT_3[gi2 * 3 + 1], SIMPLEX_GRADIENT_3[gi2 * 3 + 2], x2, y2, z2);
		
		final float t3 = 0.6F - x3 * x3 - y3 * y3 - z3 * z3;
		final float n3 = t3 < 0.0F ? 0.0F : (t3 * t3) * (t3 * t3) * doDotXYZ(SIMPLEX_GRADIENT_3[gi3 * 3 + 0], SIMPLEX_GRADIENT_3[gi3 * 3 + 1], SIMPLEX_GRADIENT_3[gi3 * 3 + 2], x3, y3, z3);
	 ...
	 */
	public static float simplexNoise(final float x, final float y, final float z, final float w) {
		...
		final float n0 = t0 < 0.0F ? 0.0F : (t0 * t0) * (t0 * t0) * doDotXYZW(SIMPLEX_GRADIENT_4[gi0 * 4 + 0], SIMPLEX_GRADIENT_4[gi0 * 4 + 1], SIMPLEX_GRADIENT_4[gi0 * 4 + 2], SIMPLEX_GRADIENT_4[gi0 * 4 + 3], x0, y0, z0, w0);
		
		final float t1 = 0.6F - x1 * x1 - y1 * y1 - z1 * z1 - w1 * w1;
		final float n1 = t1 < 0.0F ? 0.0F : (t1 * t1) * (t1 * t1) * doDotXYZW(SIMPLEX_GRADIENT_4[gi1 * 4 + 0], SIMPLEX_GRADIENT_4[gi1 * 4 + 1], SIMPLEX_GRADIENT_4[gi1 * 4 + 2], SIMPLEX_GRADIENT_4[gi1 * 4 + 3], x1, y1, z1, w1);
		
		final float t2 = 0.6F - x2 * x2 - y2 * y2 - z2 * z2 - w2 * w2;
		final float n2 = t2 < 0.0F ? 0.0F : (t2 * t2) * (t2 * t2) * doDotXYZW(SIMPLEX_GRADIENT_4[gi2 * 4 + 0], SIMPLEX_GRADIENT_4[gi2 * 4 + 1], SIMPLEX_GRADIENT_4[gi2 * 4 + 2], SIMPLEX_GRADIENT_4[gi2 * 4 + 3], x2, y2, z2, w2);
		
		final float t3 = 0.6F - x3 * x3 - y3 * y3 - z3 * z3 - w3 * w3;
		final float n3 = t3 < 0.0F ? 0.0F : (t3 * t3) * (t3 * t3) * doDotXYZW(SIMPLEX_GRADIENT_4[gi3 * 4 + 0], SIMPLEX_GRADIENT_4[gi3 * 4 + 1], SIMPLEX_GRADIENT_4[gi3 * 4 + 2], SIMPLEX_GRADIENT_4[gi3 * 4 + 3], x3, y3, z3, w3);
		
		final float t4 = 0.6F - x4 * x4 - y4 * y4 - z4 * z4 - w4 * w4;
		final float n4 = t4 < 0.0F ? 0.0F : (t4 * t4) * (t4 * t4) * doDotXYZW(SIMPLEX_GRADIENT_4[gi4 * 4 + 0], SIMPLEX_GRADIENT_4[gi4 * 4 + 1], SIMPLEX_GRADIENT_4[gi4 * 4 + 2], SIMPLEX_GRADIENT_4[gi4 * 4 + 3], x4, y4, z4, w4);
	 ...
	 * @return a {@code float} with noise computed by a Simplex-based turbulence algorithm using the coordinate X
	 */
	public static float simplexTurbulence(final float x, final float amplitude, final float frequency, final float gain, final float lacunarity, final int octaves) {
		float currentAmplitude = amplitude;
		float currentFrequency = frequency;
	 ...
	 * @return a {@code float} with noise computed by a Simplex-based turbulence algorithm using the coordinates X and Y
	 */
	public static float simplexTurbulence(final float x, final float y, final float amplitude, final float frequency, final float gain, final float lacunarity, final int octaves) {
		float currentAmplitude = amplitude;
		float currentFrequency = frequency;
	 ...
	 * @return a {@code float} with noise computed by a Simplex-based turbulence algorithm using the coordinates X, Y and Z
	 */
	public static float simplexTurbulence(final float x, final float y, final float z, final float amplitude, final float frequency, final float gain, final float lacunarity, final int octaves) {
		float currentAmplitude = amplitude;
		float currentFrequency = frequency;
	 ...
	 * @return a {@code float} with noise computed by a Simplex-based turbulence algorithm using the coordinates X, Y, Z and W
	 */
	public static float simplexTurbulence(final float x, final float y, final float z, final float w, final float amplitude, final float frequency, final float gain, final float lacunarity, final int octaves) {
		float currentAmplitude = amplitude;
		float currentFrequency = frequency;
